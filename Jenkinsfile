        ...
        stage('Clone') {
            steps {
                timeout(time: 2, unit: 'MINUTES'){
                    git branch: 'main', credentialsId: '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', url: 'https://github.com/HTomas250223/PSD2025-IG1-Proyecto.git'
                }
            }
        }
        stage('Build') {
